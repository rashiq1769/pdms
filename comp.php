...
chart1 .fontSize = 11;
chart1.hiddenState.properties.opacity = 100; // this makes initial fade in effect
chart1.data = data;
...
series1.dataFields.value = "tonnes";
...
chart2.hiddenState.properties.opacity = 100; // this makes initial fade in effect
chart2 .fontSize = 11;
...
series2.dataFields.value = "tonnes";
